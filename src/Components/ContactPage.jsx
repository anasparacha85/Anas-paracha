    ...
    data-aos-duration="1500">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Left Column */}
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-500">DON'T BE SHY !</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="text-sm text-gray-500">MAIL ME</div>
                  <div className='text-gray-400'>amiranas761@mail.com</div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className='text-gray-400'>+92 321 2167055</div>
                </div>
              </div>
            </div>
